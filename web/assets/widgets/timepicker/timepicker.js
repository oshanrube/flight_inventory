    ...
    e.prototype = {
        ...
        _init                 : function () {
            ...
            this.showWidgetOnAddonClick && (this.$element.parent().hasClass("input-append") || this.$element.parent().hasClass("input-prepend")) ? (this.$element.parent(".input-append, .input-prepend").find(".add-on").on({"click.timepicker": a.proxy(this.showWidget, this)}), this.$element.on({
                ...
                a(this).on({
                    "click.timepicker"  : function () {a(this).select()},
        ...
        showWidget            : function () {
            if (!this.isOpen && !this.$element.is(":disabled")) {
                ...
                var b = this;
                a(c).on("mousedown.timepicker, touchend.timepicker", function (a) {b.$element.parent().find(a.target).length || b.$widget.is(a.target) || b.$widget.find(a.target).length || b.hideWidget()}), this.$element.trigger({
        ...
        widgetKeyup           : function (a) {(65 === a.keyCode || 77 === a.keyCode || 80 === a.keyCode || 46 === a.keyCode || 8 === a.keyCode || a.keyCode >= 46 && a.keyCode <= 57 || a.keyCode >= 96 && a.keyCode <= 105) && this.updateFromWidgetInputs()}
